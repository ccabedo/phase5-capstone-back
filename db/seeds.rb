...
r1 = Review.create(review: "true", user_id:u2.id, listing_id:l2.id)
r2 = Review.create(review: "false", user_id:u2.id, listing_id:l1.id)
r3 = Review.create(review: "true", user_id:u3.id, listing_id:l3.id)
r4 = Review.create(review: "true", user_id:u1.id, listing_id:l1.id)
